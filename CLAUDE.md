...
| `reflow.py` | Phase 2 helper — join soft-wrapped prose lines into one line per paragraph and strip emphasis that wraps a whole paragraph; leaves headings, lists, tables, blockquotes, fenced code, and table-of-contents/index entries (a line ending in an arabic or roman page reference) untouched |
