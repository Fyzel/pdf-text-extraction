...
| `pdf_errors.py` | Shared `PDF_ERRORS` exception tuple (covers PyMuPDF `RuntimeError`-family and `pymupdf.mupdf.FzErrorBase`-family errors plus I/O) for the per-page extraction guards |
